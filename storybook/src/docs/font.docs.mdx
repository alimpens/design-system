...
If you are working with npm, include our package `@aram-limpens/design-system-assets` in your dependencies.
Then import `@aram-limpens/design-system-assets/font/index.css` at the beginning of your stylesheet.
