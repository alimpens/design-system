import{j as h}from"./jsx-runtime-BlAj40OV.js";import{c as f}from"./clsx-B-dksMZM.js";import{r as g}from"./index-Cs7sjTYM.js";const t=g.forwardRef(({className:a,length:o,maxLength:s,...u},p)=>h.jsx("div",{...u,ref:p,className:f("ams-form-field-character-counter",o>s&&"ams-form-field-character-counter--error",a),role:"status",children:`${o} van ${s} tekens`}));t.displayName="FormFieldCharacterCounter";try{t.displayName="FormFieldCharacterCounter",t.__docgenInfo={description:"",displayName:"FormFieldCharacterCounter",props:{length:{defaultValue:null,description:"",name:"length",required:!0,type:{name:"number"}},maxLength:{defaultValue:null,description:"",name:"maxLength",required:!0,type:{name:"number"}}}}}catch{}/**
 * @license EUPL-1.2+
